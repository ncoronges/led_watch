...
#define MY_UUID {0x73, 0x19, 0xFB, 0xB6, 0xBD, 0xA7, 0x4E, 0xA8, 0x91, 0x90, 0x30, 0xC5, 0xF4, 0x82 , 0x27, 0x8F}
PBL_APP_INFO(MY_UUID, "Big Led", "Nick Coronges", 0x5, 0x0, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE);
